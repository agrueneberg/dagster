...
def synthetic_mats_for_peered_dag_asset_keys(
    ...
    return [
        ...
        for asset_key in airflow_data.peered_dag_asset_keys_by_handle[DagHandle(dag_run.dag_id)]
    ]
...
def synthetic_mats_for_mapped_dag_asset_keys(
    ...
    return [
        dag_synthetic_mat(dag_run, airflow_data, asset_key)
        for asset_key in airflow_data.mapped_asset_keys_per_dag_handle[DagHandle(dag_run.dag_id)]
    ]
