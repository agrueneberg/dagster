...
def test_mixed_multiple_tasks_single_task_mapping_defs_sep_dags() -> None:
    ...
    assert mapping_info.asset_keys_in_dag_by_id["other_dag"] == {
        AssetKey("single_targeted_asset"),
    }
    assert mapping_info.asset_keys_in_dag_by_id["weekly_dag"] == {
        AssetKey("double_targeted_asset"),
    }
    assert mapping_info.asset_keys_in_dag_by_id["daily_dag"] == {
        AssetKey("double_targeted_asset"),
    }
