...
from dagster_airlift.in_airflow.task_proxy_operator import BaseProxyTaskToDagsterOperator
...
def custom_callback(original_task: BaseOperator) -> BaseProxyTaskToDagsterOperator:
    ...
    if original_task.dag_id == "affected_dag":
        ...
        return build_dagster_task(original_task, DefaultProxyTaskToDagsterOperator, {"retries": 1})
...
proxying_to_dagster(
    ...
    global_vars=globals(),
    operator_construction_callback=custom_callback,
)
