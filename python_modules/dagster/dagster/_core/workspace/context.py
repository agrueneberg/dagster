...
if TYPE_CHECKING:
    from dagster._core.definitions.remote_asset_graph import (
        RemoteGlobalAssetGraph,
        RemoteGlobalAssetNode,
    )
    from dagster._core.remote_representation import (
        PartitionConfigSnap,
...
class BaseWorkspaceRequestContext(LoadingContext):
    ...
    @property
    def asset_graph(self) -> "RemoteGlobalAssetGraph":
    ...
    def get_asset_node(self, asset_key: AssetKey) -> Optional["RemoteGlobalAssetNode"]:
